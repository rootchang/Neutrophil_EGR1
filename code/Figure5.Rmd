---
title: "Differential gene expression analysis between control mouse tumor neutrophils vs Trame treated tumor neutrophils"
...
ggsave(filename = file.path(fig_dir, "Volcano_plot_Ctrl_vs_Trame.pdf"), plot = myvolcanoplot, width = 4, height = 3.5)


```

# Fig 4h – MSigDB Pathway Enrichment
```{r}
...
# Plot
pdf(file = file.path(fig_dir, "Barplot_pathwayEnrich_Ctrl_vs_Trame_msigdb.pdf"), width = 4.4, height = 3.1)
...
# Fig 4i - Suppressive Gene FC Plot 
```{r}
...
ggsave(filename = file.path(fig_dir, "FoldChange_keyGenes_Ctrl_vs_Trame.pdf"), plot = p, width = 6.5, height = 4.5)
