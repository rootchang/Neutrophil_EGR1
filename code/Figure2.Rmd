...
```{r}
# Load log-transformed pseudo-bulk TPM expression
geneExpr_neuAtlas <- read.csv(
  "/Users/changt7/Documents/00.PostDocWork/CancerResearch/07.scRNAseq_Datasets/Neutrophil_atlas/Neutrophil_atlas_pseudobulk_TPM_Neutrophils.csv",
  sep = ",", row.names = 1
)
...
# Save output
output_path <- "/Users/changt7/Documents/00.PostDocWork/CancerResearch/07.scRNAseq_Datasets/Neutrophil_atlas/AllGenes_EGR1_pseudobulk_cor.csv"
...
################################## Fig. 2 g-k (our own single-cell transcriptomic data DEG analysis) ##################################
...
```{r}
rds_file_dir <- "/Users/changt7/Documents/00.PostDocWork/CancerResearch/09.Spatial_Datasets/GSE208253/processed_from_raw/"
...
# Extended Data Fig X – EGR1 vs IFNG Spatial Correlation (GSE208253; Arora et al. Visium spatial transcriptomics of OCSCC)
```{r}
gene_test <- "EGR1"
gene_test_show <- "EGR1"
...
# Extended Data Fig X – EGR1 vs IFNG Spatial Correlation (GSE181300; Cheng et al. Visium spatial transcriptomics of HNSCC)
```{r}
gene_test <- "EGR1"
gene_test_show <- "EGR1"
...
# Fig 2o (left); Extended Data Figure X – Spatial Map: Neutrophils vs SLC2A1+/- Cells (He et al., single-cell level spatial transcriptomics of NSCLC)
```{r}
...
# Fig 2o (right); Extended Data Figure X – Violin Plots for Neighborhood Enrichment (He et al., single-cell level spatial transcriptomics of NSCLC)
```{r}
