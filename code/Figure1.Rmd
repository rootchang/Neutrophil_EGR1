---
title: "Systematic screen identifies EGR1 as a key regulator of neutrophil-mediated immunosuppression in human oral cavity cancer"
...
```{r}
seu_GSE234933_neu <- readRDS("seu_Tissue_Neutrophils.rds")
seu_GSE234933 <- readRDS("seu_Tissue.rds")

GSE234933_neu_TPM <- read.csv("GSE234933_pseudobulk_TPM_Neutrophils.csv", row.names = 1, check.names = FALSE)
GSE234933_T_TPM <- read.csv("GSE234933_pseudobulk_TPM_T_cells.csv", row.names = 1, check.names = FALSE)
...
GSE234933_cellRatios_raw <- read.csv("GSE234933_Tissue_CellProportions_withTumorCells.csv", row.names = 1, check.names = FALSE)
...
```{r}
NSCLCatlas_neu_TPM <- read.csv("NSCLCatlas_pseudobulk_TPM_Neutrophils_geneSymbols.txt", sep = ",", row.names = 1)
NSCLCatlas_T_TPM <- read.csv("NSCLCatlas_pseudobulk_TPM_T_geneSymbols.txt", sep = ",", row.names = 1)

NSCLCatlas_cell_ratios <- read.csv("NSCLCatlas_CellProportions_L2.csv", sep = ",", row.names = 1)
